		...
		<form action="employeeupdate.action" method="post" id="employeeForm">
			<table>
				...
				<tr>
					<th>주민번호</th>
					<td>
						<input type="text" id="ssn1" name="ssn1" value="${employee.ssn1 }"style="width:100px;" />
				...
				<tr>
					<th>양/음력</th>
					<td>
						<input type="radio" value="0"  id="lunar0" name="lunar"  ${employee.lunar == 0 ? "checked=\"checked\"" :"" }/>
						<label for="lunar0">양력</label>
						<input type="radio" value="1"  id="lunar1" name="lunar"  ${employee.lunar == 1 ? "checked=\"checked\"" :"" }/>
				...
				<tr>
					<th>전화번호</th>
					<td>
						<input type="tel" id="tel" name="telephone" value="${employee.telephone }"/>
					</td>
				</tr>
				<!-- <tr>
					<th>지역</th>
...
<!-- 			<tr>
				...
				<tr>
					<td colspan="2" align="center">
						<br /><br />
						<button  type="button" class="btn" id="updateBtn" style="width: 40%">직원수정</button>
